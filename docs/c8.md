...
1. What is the underlying mathematical concept that makes public/private key
encryption secure?
...
1. Which of the keys can be sent across the Internet in plain text without
...
1. Where does the Secure Sockets Layer (SSL) fit in the
...
1. If you were properly using https in a browser over WiFi in a cafe,
...
1. What changes to the IP layer were needed to make secure
...
1. If a rogue element was able to monitor all packets going through an
...
1.  What is the purpose of a Certificate Authority in public/private
key encryption?
...
1.  The ARPANET network was in operation starting in the 1960s. Secure
...
1.  Which of these answers is "Security is fun" encrypted with a Caesar
Cipher shift of 1.
