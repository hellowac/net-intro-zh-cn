...
1. How long might a message be stored in an intermediate computer
...
1. In addition to breaking large messages into smaller segments to be
...
1. Why is it virtually free to send messages around the world
using the Internet?
