...
1. Which of the layers concerns itself with getting a packet of data
...
1. In addition to the data, source, and destination addresses, what else
...
1. In a typical networked client/server application, where does the client
application run?
